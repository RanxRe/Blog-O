            ...
            <Card className='cursor-pointer' >
                <CardContent>
                    ...
                    <div className='rounded p-2 my-2' >
                        {/* feature image */}
                        <img className='rounded w-full h-52 object-cover' loading="lazy" decoding="async" src={data?.featuredImage} alt="https://res.cloudinary.com/dylu28ncu/image/upload/v1774247661/samples/balloons.jpg" />
                    </div>
